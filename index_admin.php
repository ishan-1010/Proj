        ...
        <th style='text-align:right'>Latest Transaction Date</th>
            ...
            <section id="first" class="main special">
                ...
                <div class="graph-container" style="border-top: 1px solid rgba(0, 0, 0, 0.1); border-bottom: 1px solid rgba(0, 0, 0, 0.1); margin: 20px 0; padding: 20px 0;">
                    <img src="sales_by_product.png" alt="Graph" style='max-width: 100%'>
                    <img src="sales_by_date.png" alt="Graph" style='max-width: 100%'>
                    <img src="sales_by_user.png" alt="Graph" style='max-width: 100%'>
                    <img src="top_selling.png" alt="Graph" style='max-width: 100%'>
